<%-- 
    Document   : salerRegister
    Created on : 2016-10-25, 21:18:22
	...
	<div class="container">
		<div class="account_grid">
			   <div class="col-md-6 login-right">
                               <form action="/register/buyserRegister.do">
                                   <table>
                                       <tr><th><h2>注册</h2></th></tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="button"  value="已有买家账号？一键成为卖家"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2"><p style="color:red">*本平台仅支持快捷支付，请仔细核对银行卡号。</p></td>
                                        </tr>
                                        <tr><!--输入密码两次不一致 显示错误信息-->
